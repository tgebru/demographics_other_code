function new_preds=multiply_adjust_predictions(images,image_preds,census_atts,... 
  input_ims,input_groups,class_priorss_att_prior,att_census_prior,class_census_prior)
