...
for g=1:numel(gsv_weights)
  for a=2:2%7%num_car_attributes
      ...
      for nb=1:num_trials
        ...
        for num_car_bins=1:num_car_trials
          ...
          if options.learn
            ...
            image_preds_prior=adjust_predictions(images,image_preds,val_census_bin_vars,val_cur_ims,val_cur_groups,class_prior,class_att_prior,att_census_prior,class_census_prior);
            fprintf('evaluating\n');
